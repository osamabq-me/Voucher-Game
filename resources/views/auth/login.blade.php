<x-guest-layout>
    ...
    <div class="flex items-center justify-center mt-4">
        <a href="{{ url('auth/github') }}" class="flex items-center px-4 py-2 font-bold text-white bg-gray-800 rounded-lg hover:bg-gray-700">
            <i class="fa-brands fa-github me-2"></i> {{ __('Login with GitHub') }}
        </a>
    </div>
</x-guest-layout>
